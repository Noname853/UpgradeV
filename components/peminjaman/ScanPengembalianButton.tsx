...
// Dialog scan pengembalian (admin), versi terkontrol: scan barang apa pun dari
// tumpukan kembalian, sistem menemukan peminjaman aktifnya dan menawarkan
// lompat langsung ke halaman pengembaliannya. Dipisah dari tombolnya supaya
// bisa dipicu dari mana saja (mis. FAB tengah bottom-nav mobile).
export function ScanPengembalianDialog({ open, onClose }: { open: boolean; onClose: () => void }) {
...
// Scan global pengembalian (admin) — tombol + dialog. Dipakai di halaman
// daftar peminjaman.
export function ScanPengembalianButton() {
  ...
  return (
    <>
      ...
      <ScanPengembalianDialog open={open} onClose={() => setOpen(false)} />
    </>
  )
}
